...
const orderSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchNewOrders.fulfilled, (state, action) => {
      ...
      // const currentOrderIds = [ ...currentItems.new ].map( o => o.id )
      // const newOrders = payload.orders.filter( o => !currentOrderIds.includes(o.id))

      // console.log('present', currentOrderIds)
      // console.log('new', newOrders)
      // console.log('final', {
      //   ...state.items,
      //   new: [...newOrders, ...state.items.new],
      // })

      // currentItems = { ...state.items, new: [...newOrders, ...state.items.new]};
      // state.items.new.push =  [...newOrders, ...state.items.new]
      ...
      delete state.items.new;
      state.items.new = payload.orders;
